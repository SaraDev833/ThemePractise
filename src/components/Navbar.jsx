...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex justify-between w-full items-center bg-cyan-800 py-4! px-4! '>
        <h2 className='text-2xl text-white cursor-pointer dark:text-black'>CodeWithSara</h2>
        <ul className='flex gap-4 text-xl items-center'>
          <button className='text-white' onClick={()=>setTheme(theme==="light"?"dark":"light")}>{theme === "light"?"LightMode":"DarkMode"}</button>
